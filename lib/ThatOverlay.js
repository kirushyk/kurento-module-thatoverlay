 ...
 *
 * @param {external:Integer} x
 *  Title left edge X coordinate.
 *
 * @param {external:Integer} y
 *  Title top edge Y coordinate.
 *
 ...
 */
ThatOverlay.prototype.setup = function(x, y, title, titleFont, tR, tG, tB, tA, watermark, watermarkFont, wR, wG, wB, wA, interval, callback){
  var transaction = (arguments[0] instanceof Transaction)
                  ? Array.prototype.shift.apply(arguments)
                  : undefined;

  //  
  // checkType('int', 'x', x, {required: true});
  //  
  // checkType('int', 'y', y, {required: true});
  //  
